...
/**
 * This clas is for collecting element which arr in one type
 * and manipulate with them, inserting them, removing, setting, clearing,
 * putting and replacing them
 * @param <E>
 */
...
public class CustomArrayList<E>  {
     ...
     */
    public boolean insertIn(int index, E e) {
     ...
     */
    private void insertFront(Object[] o, E e) {
        o[0] = e;
     ...
     */
    private boolean insertBetween(Object[] newObj, int index, E e) {
     ...
     */
    public boolean replace(int startIndex, Integer... elements) {
    ...
    private void replaceOf(Integer[] elements, int startIndex) {
        for (int  j = 0; j < elements.length; ++j) {
